...
const STORAGE_KEY = 'xhblogs_pending_operations';
const OperationContext = createContext<OperationContextType | undefined>(undefined);

function loadSavedOperations(): Operation[] {
...
export function OperationProvider({ children }: { children: React.ReactNode }) {
  const [operations, setOperations] = useState<Operation[]>(loadSavedOperations);
...
export const useOptionalOperations = () => {
